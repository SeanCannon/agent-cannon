...
echo "  Agents:     $DEST_BASE/agents/ac-*.md ($(ls "$REPO_DIR"/agents/ac-*.md 2>/dev/null | wc -l | tr -d ' ') agents)"
echo "  Commands:   $DEST_BASE/command/ac-*.md ($(ls "$REPO_DIR"/command/ac-*.md 2>/dev/null | wc -l | tr -d ' ') commands)"
